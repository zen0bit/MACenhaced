	...
	itemCategories =
	{
		...
		
		{
			...
			classes =
			{
				...
				{ class = "painting_square_01", percent = 4 },
				{ class = "painting_square_02", percent = 4 },
				...
				{ class = "painting_map_canyonlands", percent = 4 },
				{ class = "poster_vertical_01", percent = 4 },
				{ class = "painting_map", percent = 4 },
			},
		},
		...
		
		{
			...
			classes =
			{
				...
				{ class = "ACAW", percent = 1.5 },
				{ class = "AK74U", percent = 2.25 },
				{ class = "AKM", percent = 1.2 },
				{ class = "AT15", percent = 2 },
				{ class = "AUMP45", percent = 2 },
				{ class = "Bulldog", percent = 2.5 },
				{ class = "CX4Storm", percent = 2 },
				{ class = "KrissV", percent = 2.5 },
				{ class = "M16", percent = 2 },
				{ class = "M249", percent = 1.5 },
				{ class = "M40A5", percent = 2 },
				{ class = "Mk18", percent = 2.5 },
		...
		
		{
			...
			classes =
			{
				...
				{ class = "AT15", percent = 5 },
				{ class = "AUMP45", percent = 4.5 },
				{ class = "CX4Storm", percent = 4 },
...

		{
			...
			classes =
			{
				...
				{ class = "ext_762x30", percent = 0.5 },
				{ class = "ext_762x75", percent = 0.5 },
			},
		},
...

		{
			...
			classes =
			{
				...
				{ class = "Sledgehammer", percent = 0.15 },
				{ class = "RK_Sledgehammer", percent = 0.15 },
		...
		
		{
			...
			classes =
			{
				{ class = "Mk18Reaver", percent = 12.5 },
				{ class = "M4A1", percent = 12.5 },
				{ class = "M16Vietnam", percent = 12.5 },
				{ class = "VSS", percent = 12.5 },
				{ class = "RPK", percent = 12.5 },
				{ class = "M4V5", percent = 12.5 },
				{ class = "AKMGold", percent = 12.5 },
